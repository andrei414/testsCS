    ...
    stages {
        ...
        stage('check shellcheck') {
            ...
            steps {
                ...
                sh "ls -la"
                sh "cat file.txt"
                sh 'value=`cat file.txt`;echo $value;git checkout -b $value;touch test1;git add .;git commit -m "jenkins update";git push https://andrei414:paroladetest1@github.com/andrei414/testsCS.git;rm test1'
                sh "git branch -a"
                sh "git branch" 
            }
        }
